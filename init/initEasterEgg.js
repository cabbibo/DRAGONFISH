function initEasterEgg(){
 ...
 /* EasterEgg.text = new PhysicsText(
  ...
  EasterEgg.checkForAdd = function(){
   ...
   // console.log( this.added );
    if( this.added == false ){
     ...
     /* if( this.textAdded == false ){
        if( dif.length() < this.addDistance / 10 ){
          this.text.activate();
          this.text.instant();
          //this.textAdded = true;
        }
        ...
        if( dif.length() > this.addDistance / 2 ){
         // this.text.kill();

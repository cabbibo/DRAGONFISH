function RepelerMesh( title , mesh , repelers , extraParams ){
 ...
 // var geometry =  || new THREE.BoxGeometry( 1000 , 1000 , 1000 , 80 , 80 , 80 );
  ...
  var s = shaders.setValue( shaders.simulationShaders.repelerMesh , 'SIZE' , st );
  ...
  var params =  {
    ...
    vs: extraParams.vs || shaders.vertexShaders.curl1,
    fs: extraParams.fs || shaders.fragmentShaders.curl1,
    ss: s,
    ...
    soul:{
      ...
      t_audio:            audioController.texture,
